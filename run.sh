...
python $args --contour ./evaluation/contours/rectangle.txt --output rectangle-gqs --criterions nlccs ciou

python $args --contour ./evaluation/contours/irregular.txt --output irregular-gcs --criterions nlccs fiou
